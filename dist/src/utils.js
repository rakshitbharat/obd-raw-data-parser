 ...
 */
export const convertPIDHexToValue = (hex) => {
 ...
 */
export const convertVoltageHexToValue = (hex) => {
 ...
 */
export const getValueFromResponse = (command, response) => {
    if (!command || !response)
        return '';
 ...
 */
export const getUnsignedInt = (hex) => {
    const value = parseInt(hex, 16);
