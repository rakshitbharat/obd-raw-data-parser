...
function convertLambda(
  ...
  var reply: any = {};
  reply.ratio = formatNumber(((parseInt(byteA, 16) * 256 + parseInt(byteB, 16)) * 2) / 65535);
  reply.voltage = formatNumber(((parseInt(byteC, 16) * 256 + parseInt(byteD, 16)) * 8) / 65535);
  return reply;
}
...
function convertLambda2(
  ...
  var reply: any = {};
  reply.ratio = formatNumber((parseInt(byteA, 16) * 256 + parseInt(byteB, 16)) / 32768);
  reply.voltage = formatNumber((parseInt(byteC, 16) * 256 + parseInt(byteD, 16)) / 256 - 128);
  return reply;
}
...
function convertShortOxygenSensorOutput(byteA: string, byteB: string) {
  var reply: any = {};
  reply.bank1 = formatNumber(((parseInt(byteA, 16) - 128) * 100) / 128);
  reply.bank2 = formatNumber(((parseInt(byteB, 16) - 128) * 100) / 128);
  return reply;
}
