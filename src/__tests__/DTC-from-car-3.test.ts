...
describe("DTC From Car Tests - Additional Patterns", () => {
  ...
  test("should handle consecutive data requests", () => {
    ...
    const responses = [
      // First request
      [[52,51,48,48,13],[52,51,48,48,13],[13,62]],
      // Second request
      [[52,51,48,50,48,50,57,57,48,53,57,70,13],[13,62]],
      // Third request
      [[52,51,48,50,48,49,48,50,48,49,49,51,13],[13,62]]
    ];
  ...
  test("should handle mode changes in sequence", () => {
    ...
    const responses = [
      [[52,51,48,50,48,49,48,50,48,49,49,51,13],[13,62]], // Mode 03
      [[52,55,48,50,48,50,57,57,48,53,57,70,13],[13,62]], // Mode 07
      [[52,65,48,50,48,53,57,70,48,50,57,57,13],[13,62]]  // Mode 0A
    ];
